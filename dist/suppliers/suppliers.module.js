...
exports.SuppliersModule = SuppliersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [suppliers_service_1.SuppliersService, adapters_1.UuidAdapter, adapters_1.HandleDBErrors],
        imports: [typeorm_1.TypeOrmModule.forFeature([supplier_entity_1.Supplier]), auth_module_1.AuthModule],
        exports: [typeorm_1.TypeOrmModule, suppliers_service_1.SuppliersService]
    })
], SuppliersModule);
